...
De lijst URL in het [&#x200B; gegevenspakhuis &#x200B;](/help/data-warehouse/data-warehouse-schema.md){target="_blank"} zal nu een gebied van de paginatitel, naast de lijsten van Webgegevens omvatten.
...
* [&#x200B; Nieuwe Discover Gids van het Dashboard &#x200B;](/help/marketo-measure-discover-ui/new-discover-dashboard-guide.md){target="_blank"}
* [&#x200B; ontdekt de Grondbeginselen van het Dashboard &#x200B;](/help/marketo-measure-discover-ui/discover-dashboard-basics.md){target="_blank"}
* [&#x200B; Dashboard van het Overzicht van de Opbrengst &#x200B;](/help/marketo-measure-discover-ui/revenue-overview-dashboard.md){target="_blank"}
...
* [&#x200B; Dashboard van het Paspoort &#x200B;](/help/marketo-measure-discover-ui/passport-dashboard.md){target="_blank"}
...
![&#x200B; het rapporttype van Salesforce opstelling voor Leads/Contacten met Touchpoints &#x200B;](assets/release-notes-2023-1.png)
...
![&#x200B; de kolommen van het Rapport die erfenisLood en de gebieden van het Contact FT/LC benadrukken om te verwijderen &#x200B;](assets/release-notes-2023-2.png)

* Velden voor aanraakpunten toevoegen:

![&#x200B; de kolommen van het Rapport die de gebieden van het Aanraakpunt tonen om in plaats van de gebieden van FT/LC toe te voegen &#x200B;](assets/release-notes-2023-3.png)
...
![&#x200B; de filterconfiguratievoorbeeld van de Positie van het Aanraakpunt &#x200B;](assets/release-notes-2023-4.png)

![&#x200B; het gebiedsfilter van de Datum dat aan Op aanraakpunt-Gebaseerde gebieden wordt bijgewerkt &#x200B;](assets/release-notes-2023-5.png)
