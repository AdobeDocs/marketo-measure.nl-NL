...
[!DNL Marketo Measure] trekt bijna alles dat het van uw CRM dagelijks nodig heeft, maar er zijn een paar onderhoudstaken u regelmatig zou moeten plannen om te houden [!DNL Marketo Measure] de meest nauwkeurige informatie die mogelijk is, op een hummende manier te verstrekken.

**Aanraakpunten voor kopers synchroniseren voor nieuwe offlinecampagnes (2 x/maand)**

Zoals u tijdens het instappen hebt geleerd, [!DNL Marketo Measure] krijgt informatie over uw off-line marketing inspanningen door met de campagnes van uw CRM te synchroniseren. Als uw organisatie nieuwe campagnes start, moet u ervoor zorgen dat kopers aanraakpunten hebben voor elke campagne.

**Uploaduitgaven voor alle kanalen (1x/maand)**

Profiteer van de volledige mogelijkheden voor inkomsten- en investeringsrendement voor[!DNL Marketo Measure], moet u [!DNL Marketo Measure] hoeveel u aan elk van uw marketing kanalen en subkanalen besteedt. Wijs de eigenaar van elk kanaal/subkanaal aan en zorg ervoor dat deze personen uitgaven aan één enkele partij melden die verantwoordelijk is voor het maandelijks uploaden van nieuwe kosteninformatie.
...
Onthoud, [!DNL Marketo Measure] verwerkt uw gegevens opnieuw wanneer u toewijzingslogica uitgeeft, zodat zult u deze regels niet meer dan eens om de zeven dagen kunnen veranderen.
