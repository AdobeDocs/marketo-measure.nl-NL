...
>[!CAUTION]
>
>In dit artikel worden Single Sign On (SSO) en het geavanceerde CRM-gebruikersbeheer beschreven. Als uw rekening **na 9/10/2020** werd voorzien, negeert dit artikel, aangezien SSO en Identity Management binnen [&#x200B; Adobe Admin Console voor uw  [!DNL Marketo Measure]  integratie &#x200B;](/help/implementation-guide.md) zullen worden geplaatst.
...
![&#x200B; om begonnen te worden, navigeer aan de pagina van de Authentificatie van de Veiligheid van Montages in &#x200B;](assets/compliance-resources-1.png)
...
Overschakelen naar Aangepaste SSO in de [!DNL Marketo Measure] -toepassing
     ...
     a. Zodra de FactureringsGroep voor uw Rekening is toegelaten, kunt u nu aan [!UICONTROL Settings] > [!UICONTROL Security] >> [!UICONTROL Authentication]
    
     b navigeren. Door gebrek, zal uw Login Type aan &quot;Gebruikers van CRM worden geplaatst.&quot;
...
Stel uw gebruikerskenmerkinstellingen in en wijs deze toe aan de respectievelijke voornaam, achternaam en e-mailadres.
     ...
     i. E-mailAttribuut: Verstrek de attributennaam die uw Identiteitsprovider voor het e-mailadres van de gebruiker gebruikt.
     ii. Eerste Attribuut van de Naam: Verstrek de attributennaam die uw Leverancier van de Identiteit voor de voornaam van de gebruiker gebruikt.
     iii. Attribuut van de Achternaam: Verstrek de attributennaam die uw Leverancier van de Identiteit voor achternaam van de gebruiker gebruikt.
...
![&#x200B; b. Tip: Als u uw configuratie van SAML nu test, zullen wij &#x200B;](assets/discover-control-1.png) ontleden
...
Opstelling en kaart uw montages van de Rol van de Gebruiker aan de respectieve rollen of de groepen die van uw IdP worden geclassificeerd.
     ...
     b. Als geen rollen of groepen in kaart worden gebracht, het gebrek dat is dat alle werknemers in de Leverancier van de Identiteit Standaardgebruikerstoegang zullen hebben.
     ...
     ii. [!DNL Marketo Measure]  Gebruiker van de Rekening Admin: Verstrek de rol of groepswaarde (van uw leverancier SSO) voor gebruikers die administratieve toegang zouden moeten hebben tot de  [!DNL Marketo Measure]  toepassing. Dit betekent dat de rol toegang tot veranderingsconfiguraties en montages met betrekking tot uw Rekening heeft.
     iii. U moet een attribuut in uw IdP met de nauwkeurige naam van &quot;groepen&quot;hebben die de waarden u in de &quot;Bizible Standard Gebruiker&quot;of &quot;Bizible de attributen van Admin van de Rekening Admin&quot;plaatst.
...
![&#x200B; c. Als de veelvoudige rollen of de groepen aan een rol zouden moeten worden in kaart gebracht, &#x200B;](assets/discover-control-2.png)

Test de Single Sign On configuratie

     a. Alvorens u sparen kunt raken, zult u de [!UICONTROL Test SAML Authentication] knoop moeten klikken om te verifiëren dat uw montages behoorlijk werden gevormd.
    
     b. Als u een &quot;mislukking&quot;fout ziet, volg het bericht en probeer opnieuw.

![&#x200B; b. Als u een &quot;mislukking&quot;fout ziet, volg het bericht en de poging &#x200B;](assets/discover-control-3.png)
...
![&#x200B; a. Belangrijk: Zodra u uw nieuwe montages van de Authentificatie opslaat, is het mogelijk &#x200B;](assets/discover-control-3.png)

Probeer het uit!

     a. Gebruik uw nieuw douaneteken binnen URL en poging om terug binnen aan de  [!DNL Marketo Measure]  Toepassing met uw geloofsbrieven van de Leverancier van de Identiteit te registreren.
    
     b. Het formaat zal als &quot;https://apps.adobe.com/business/[accountName] &grave; 
    
     c kijken. Gefeliciteerd. U hebt met succes opstelling het Enige Teken in de  [!DNL Marketo Measure]  Toepassing voor uw rekening!

![&#x200B; c. Gefeliciteerd. U hebt met succes opstelling Enige Teken in &#x200B;](assets/discover-control-3.png)
...
![&#x200B; voor de Rollen van Salesforce, gebruik de naam van elke Rol. Alle rollen &#x200B;](assets/discover-control-3.png)
...
![&#x200B; voor de Rollen van de Dynamiek, gebruik de naam van elke Rol van de Veiligheid. Alle &#x200B;](assets/discover-control-3.png)
...
![&#x200B; Zodra de Douane SSO opstelling is geweest, is de pagina van Gebruikers &#x200B;](assets/discover-control-3.png)
