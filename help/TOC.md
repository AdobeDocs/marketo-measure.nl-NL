...
+ Inleiding tot [!DNL Marketo Measure] {#introduction-to-marketo-measure}
   + Overzichtsbronnen {#overview-resources}
      ...
      + [[!DNL Marketo Measure] Attributiemodellen](introduction-to-marketo-measure/overview-resources/marketo-measure-attribution-models.md)
      + [[!DNL Marketo Measure] Framework](introduction-to-marketo-measure/overview-resources/marketo-measure-framework.md)
      + [Verklarende woordenlijst van  [!DNL Marketo Measure]  Gebieden](introduction-to-marketo-measure/overview-resources/glossary-of-marketo-measure-fields.md)
+ [!DNL Marketo Measure] Tekstspatiëring {#marketo-measure-tracking}
   + Bijhouden instellen {#setting-up-tracking}
      + [Beste praktijken voor het Uitvoeren van  [!DNL Marketo Measure]  JavaScript](marketo-measure-tracking/setting-up-tracking/best-practices-for-implementing-marketo-measure-javascript.md)
      + [Toevoegend  [!DNL Marketo Measure]  Manuscript](marketo-measure-tracking/setting-up-tracking/adding-marketo-measure-script.md)
      + [Het toevoegen van  [!DNL Marketo Measure]  Manuscript via de Manager van de Markering van Google](marketo-measure-tracking/setting-up-tracking/adding-marketo-measure-script-via-google-tag-manager.md)
      ...
      + [!DNL Marketo Measure] Script toevoegen aan verschillende formulierproviders {#adding-marketo-measure-script-to-different-form-providers}
         + [Toevoegend  [!DNL Marketo Measure]  JavaScript aan Paragraaf](marketo-measure-tracking/setting-up-tracking/adding-marketo-measure-script-to-different-form-providers/adding-marketo-measure-javascript-to-pardot.md)
         + [Toevoegend  [!DNL Marketo Measure]  Manuscript aan Lichtbak Forms](marketo-measure-tracking/setting-up-tracking/adding-marketo-measure-script-to-different-form-providers/adding-marketo-measure-script-to-lightbox-forms.md)
         + [Toevoegend  [!DNL Marketo Measure]  Manuscript aan de Pagina&#39;s van de Sitecore](marketo-measure-tracking/setting-up-tracking/adding-marketo-measure-script-to-different-form-providers/adding-marketo-measure-script-to-sitecore-pages.md)
         + [Toevoegend  [!DNL Marketo Measure]  Manuscript aan Uberflip Forms](marketo-measure-tracking/setting-up-tracking/adding-marketo-measure-script-to-different-form-providers/adding-marketo-measure-script-to-uberflip-forms.md)
      ...
      + [Definitie van  [!DNL Marketo Measure]  zittingen van het Web](marketo-measure-tracking/setting-up-tracking/definition-of-marketo-measure-web-sessions.md)
...
+ Geavanceerde [!DNL Marketo Measure] functies {#advanced-marketo-measure-features}
   ...
   + Aangepast inkomstenbedrag {#custom-revenue-amount}
      ...
      + [Het gebruiken van de Lader van Gegevens om  [!DNL Marketo Measure]  Gebied van het Bedrag van de Douane bij te werken](advanced-marketo-measure-features/custom-revenue-amount/using-data-loader-to-update-marketo-measure-custom-amount-field.md)
   ...
   + A/B-tests {#a-b-testing}
      ...
      + [Het vormen van de  [!DNL Marketo Measure]  Integratie van de Test A/B](advanced-marketo-measure-features/a-b-testing/configuring-the-marketo-measure-a-b-test-integration.md)
   + Chatintegratie {#chat-integration}
      + [Veelgestelde vragen over driverintegratie](advanced-marketo-measure-features/chat-integration/drift-integration-faq.md)
...
+ [!DNL Marketo Measure] en Dynamics {#marketo-measure-and-dynamics}
   + Aan de slag met [!DNL Marketo Measure] en Dynamics {#getting-started-with-marketo-measure-and-dynamics}
      ...
      + [OAuth met Azure Actieve Folder voor  [!DNL Dynamics]  CRM](marketo-measure-and-dynamics/getting-started-with-marketo-measure-and-dynamics/oauth-with-azure-active-directory-for-dynamics-crm.md)
