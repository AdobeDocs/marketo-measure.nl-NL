...
* [Nieuwe Discover-dashboardgids](/help/new-discover-dashboard-guide.md){target="_blank"}
* [Basisprincipes van dashboard ontdekken](/help/discover-dashboard-basics.md){target="_blank"}
* [Dashboard overzicht van inkomsten](/help/revenue-overview-dashboard.md){target="_blank"}
* [Toegewezen belastingdashboard](/help/attributed-revenue-dashboard.md){target="_blank"}
* [ROI Dashboard](/help/roi-dashboard.md){target="_blank"}
* [Paspoort-dashboard](/help/passport-dashboard.md){target="_blank"}
...
We zullen onze exporttaken geleidelijk afbouwen naar objecten Lead/Contact om onze integratie te vereenvoudigen en te voorkomen dat we naar standaardobjecten van Salesforce moeten exporteren. De hieronder vermelde gedenormaliseerde velden worden ook afgekeurd, omdat klanten dezelfde gegevens kunnen verkrijgen van hun Touchpoint-objecten. _**De tijdslijn van afschrijving is juni 2024.**_
