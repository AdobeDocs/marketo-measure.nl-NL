...
| Naam | Beschrijving |
| --- | --- |
| Knop Filterschakelen | Hiermee schakelt u het filtervenster in of uit. |||||||||||||||||||||||||![ — | — |] (apng) |
| Zoekbalk | Gebruik het onderzoek bij de bovenkant van de filterruit aan onderzoek naar een specifiek filter. Elk filter heeft ook een eigen zoekbalk. ||||||||||||||||||||||||||![ — | — |] (apng) |
| Filterknop wissen | Als u een filter wilt wissen, klikt u op het gummetje in de rechterbovenhoek van elk filter. ||||||||||||||||||||||||||![ — | — |] (apng) |
| Knop toepassen | Klik om de filterwijzigingen op het dashboard te bevestigen en te implementeren. |||||||||||||||||||||![ — | — |] (apng) |
...
![&#x200B; om de onderliggende gegevens van visueel uit te voeren, beweegt over zijn top-right &#x200B;](assets/discover-basics-6.gif)
