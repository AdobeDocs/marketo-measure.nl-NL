---
description: Introduceert de Discover dashboard-interface, filters, booracties, cross-filtering, export en focusmodus
...
| Naam | Beschrijving |
| --- | --- |
| Knop Filterschakelen | Hiermee schakelt u het filtervenster in of uit. ![| --- | --- |](assets/discover-basics-9.png) |
| Zoekbalk | Gebruik het onderzoek bij de bovenkant van de filterruit aan onderzoek naar een specifiek filter. Elk filter heeft ook een eigen zoekbalk. ![| --- | --- |](assets/discover-basics-10.png) |
| Filterknop wissen | Als u een filter wilt wissen, klikt u op het gummetje in de rechterbovenhoek van elk filter. ![| --- | --- |](assets/discover-basics-11.png) |
| Knop toepassen | Klik om de filterwijzigingen op het dashboard te bevestigen en te implementeren. ![| --- | --- |](assets/discover-3a-1.png) |
...
![ Hover over de top-juiste hoek van een visuele om een read-only lijst van ](assets/discover-3b-1.png) te zien
...
![ Beweeg over visueel om te identificeren als het een hiërarchie heeft; ](assets/discover-basics-7.png)
...
![ activeer boor-benedenwaarts door de enige benedenwaartse pijl te klikken, die door grijs ](assets/discover-basics-8.png) wordt benadrukt
...
![ om één gebied in een tijd neer te boren, zet boor-down ](assets/discover-basics-2.gif) aan

Gebruik het pictogram met de dubbele pijl om naar het volgende hiërarchische niveau te gaan.

![ gebruik het dubbele pijl boor-benedenpictogram om aan de volgende hiërarchie ](assets/discover-basics-1.gif) te voorschijn te gaan

Gebruik het vorkachtige pictogram om een extra hiërarchisch niveau in uw huidige mening toe te voegen.

![ gebruik het vork-als pictogram om een extra hiërarchieniveau in uw ](assets/discover-basics-12.gif) toe te voegen
...
![ om de gegevens achter het visuele te onderzoeken, klik het visuele element met de rechtermuisknop aan en ](assets/discover-basics-13.gif)
...
![Om de onderliggende gegevens van visueel uit te voeren, houd over zijn top-right ](assets/discover-basics-6.gif)
...
![ om binnen op een specifieke visuele of tegel te zoemen, over ](assets/discover-basics-5.gif) te bewegen
...
![ het Selecteren van een waarde of een asetiket in één visualisatie zal andere ](assets/discover-basics-3.gif) kruisen
...
![ Tooltips biedt extra details over de getoonde gegevens aan. Houd de muis boven een visuele ](assets/discover-basics-4.gif)
