...
1. Teken binnen aan uw [&#x200B; Portaal van Azure &#x200B;](https://portal.azure.com/#home).

1. Kies de Azure AD-huurder door op uw account in de rechterbovenhoek van de pagina te klikken, gevolgd door op de navigatie Switch Directory te klikken en vervolgens de juiste huurder te selecteren. Sla deze stap over als u slechts één Azure AD-medewerker onder uw account hebt of als u al de juiste Azure AD-medewerker hebt geselecteerd.

   ![1. Kies de Azure AD-huurder door op uw account te klikken in de &#x200B;](assets/bizible-taxonomy-1.png)

1. Zoek naar &quot;[!DNL Azure Active Directory]&quot;in de onderzoeksbar en klik de naam om te openen.

   ![1. Zoek naar &quot;Actieve Folder van Azure&quot;in de onderzoeksbar en &#x200B;](assets/microsoft-guide-1.png)
...
c. Geef de Redirect URI op. Voor webtoepassingen is dit de basis-URL van uw app waar gebruikers zich kunnen aanmelden. Bijvoorbeeld `http://localhost:12345` . Voor openbare clients (mobiel en bureaublad) gebruikt Azure AD dit om tokenreacties te retourneren. Voer een waarde in die specifiek is voor uw toepassing. Bijvoorbeeld `http://MyFirstAADApp` .

1. Nadat u de registratie hebt voltooid, wijst Azure AD uw toepassing een unieke client-id toe (de toepassings-id). U hebt deze waarde in de volgende sectie nodig, kopieer deze dus van de toepassingspagina.

1. Klik op **[!UICONTROL App Registrations]** en klik vervolgens op **[!UICONTROL All Applications]** om de toepassing te zoeken in de Azure-portal. De nieuwe toepassing openen
...
1. Als de instelling juist is, wordt de waarde automatisch ingevuld in de velden **[!UICONTROL Application ID URI]** en **[!UICONTROL Azure AD Object Id]** nadat u **[!UICONTROL Save]** hebt geselecteerd.
...
![&#x200B; b. Clientgeheim is het toepassingsgeheim dat is gemaakt in het Azure Portal &#x200B;](assets/microsoft-guide-11.png)

c. De toepassings-id URI is de URL van de doel-web-API (beveiligde bron). Als u de URL van de toepassings-id wilt zoeken, klikt u in de Azure Portal op [!DNL Azure Active Directory] , klikt u op Toepassingsregistraties, opent u de pagina Instellingen van de toepassing en klikt u vervolgens op Eigenschappen. Het kan ook een externe bron zijn zoals `https://graph.microsoft.com` . Dit is normaal de URL van de instantie Dynamics.
