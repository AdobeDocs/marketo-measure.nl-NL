---
description: Woordenlijst met Marketo Measure-velden
...
# Woordenlijst met Marketo Measure-velden {#glossary}
...
Voor een kaart waarvan Voorwerp elk gebied van Marketo Measure op betrekking heeft, [ klik hier ](/help/configuration-and-setup/marketo-measure-object-and-field-taxonomy.md).

[ A ](#a) ・ [ B ](#b) ・ [ C ](#c) ・ [ D ](#d) ・ [ E ](#e) ・ [ F ](#f) ・ [ G ](#g) ・ H ・ I ・ J ・ J ・ [ K ](#k) ・ [ L ](#l) ・ M ](#m) ・ N ・ [ O ](#o) ・ [ P ](#p) ・ Q ・ [ R ](#r) ・ [ S ](#s) ・ [ T ](#t) ・ [ U ](#u) ・ [ V ](#v) ・ X ・ Y Z[
...
![ Dit gebied toont u het marketing kanaal, en subchannel dat a ](assets/overview-resources-16.png)
