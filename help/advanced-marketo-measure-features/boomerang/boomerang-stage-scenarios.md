...
Het werkgebied van lead 1 verandert in SAL en wordt vervolgens omgezet in een contactpersoon met een opportunity. In dit geval worden de positie SAL-01 (Last) en OC gecombineerd in hetzelfde aanraakpunt.
...
SQL-01 (laatste)-aanraakpunt van lead 2 wordt niet opgenomen als aanraakpunt op de opp omdat dit na het aanraakpunt voor OC is opgetreden. Bovendien is de SQL-werkgebiedovergang van lead 2 opgetreden _na de laatste SAL-faseovergang_ en helpt niet om de opportuniteitsreis vooruit te helpen.
...
Merk op dat er geen tweede overgang aan de onderhandelingsfase is; de Kans springt onmiddellijk van demo-02 (Laatste) bewegingen aan Close Won. In dit geval: [!DNL Marketo Measure] De overgang naar onderhandelingen met het &quot;Closed Won&quot;-aanraakpunt.
