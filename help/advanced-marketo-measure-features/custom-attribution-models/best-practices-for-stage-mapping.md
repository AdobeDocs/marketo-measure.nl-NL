...
>[!MORELIKETHIS]
>
>[&#x200B; het Verschil tussen de Stages van Funnel en de Stages van het Model van de Douane &#x200B;](/help/advanced-marketo-measure-features/custom-attribution-models/custom-attribution-model-and-setup.md#the-difference-between-funnel-stages-and-custom-model-stages)
