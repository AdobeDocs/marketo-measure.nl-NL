---
description: Toevoegend  [!DNL Marketo Measure]  Manuscript -  [!DNL Marketo Measure]
...
>[!TIP]
>Leer hoe te ervoor te zorgen uw manuscript [ GDPR-Volgzaam ](/help/security/ensuring-consent-for-gdpr-in-marketo-measure-js.md){target="_blank"} is.
...
![ de waarschuwingsherinnering van WAF van het Voorbeeld voor het manuscript van Marketo Measure ](assets/adding-marketo-measure-script-1.png)
