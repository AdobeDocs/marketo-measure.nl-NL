...
>[!NOTE]
>
>Zorg ervoor u [ alle aangewezen domeinen in  [!DNL Adobe Admin Console]](/help/domain-management.md){target="_blank"} naast het opstellen van [!DNL Marketo Measure] JavaScript hebt geclaimd.
...
![ als een waarschuwing van de Firewall van de Toepassing van het Web (WAF) tijdens ](assets/adding-script-1.png) wordt teweeggebracht
...
1. Zoek de record die is gemaakt in uw CRM (lead of contact) voor het verzenden van het formulier en controleer of een aanraakpunt op de juiste wijze is gemaakt.
   ...
   a. U kunt een [!DNL Marketo Measure] -voorraadrapport gebruiken, zoals Leads met aanraakpunten voor kopers, of de pagina-indeling Lead/Contact weergeven als u uw paginalay-outs wilt bijwerken met [!DNL Marketo Measure] -gegevens.
