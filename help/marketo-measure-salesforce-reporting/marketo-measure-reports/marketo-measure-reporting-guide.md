...
De [ attributiemodellen ](/help/introduction-to-marketo-measure/overview-resources/marketo-measure-attribution-models.md){target="_blank"} die beste insight in op mensen-gebaseerde metriek verstrekken zijn:
...
De [ attributiemodellen ](/help/introduction-to-marketo-measure/overview-resources/marketo-measure-attribution-models.md){target="_blank"} die beste insight in Op opportuniteit-gebaseerde metriek verstrekken zijn:
