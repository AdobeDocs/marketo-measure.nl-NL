...
Hier volgen verschillende koppelingen naar relevante artikelen/video&#39;s om u te helpen aan de slag te gaan met [!DNL Marketo Measure] .
...
* [Marketing Channel Setup, best practices](/help/channel-tracking-and-setup/marketing-channels-and-subchannels.md)
* [Online kanaalinstelling](/help/channel-tracking-and-setup/online-custom-channel-setup.md)
* [Offlinekanaal instellen](/help/channel-tracking-and-setup/offline-custom-channel-setup.md)
* [Wat zijn UTM-parameters?](/help/channel-tracking-and-setup/utm-parameters.md)
* [Beste praktijken UTM](/help/channel-tracking-and-setup/best-practices-for-setting-up-utm-parameters.md)
* [SFDC-campagnes synchroniseren met kopersaanraakpunten](/help/channel-tracking-and-setup/campaigns-and-campaign-members.md)
* [Marketing-uitgaven uploaden](/help/marketing-channel-costs.md)
* [Advertentierekeningen opnieuw verbinden](/help/api-connections/reauthorizing-connected-accounts.md)
* [Het toevoegen van  [!DNL Marketo Measure]  JavaScript](/help/marketo-measure-tracking/adding-marketo-measure-script.md)
   * [Forms uitsluiten](/help/marketo-measure-tracking/excluding-marketo-measure-from-specific-forms.md)

**Meldend**

* [&#x200B; Creërend de Types van Rapport van de Douane met  [!DNL Marketo Measure]](/help/marketo-measure-salesforce-reporting/creating-report-types.md) (als u over de gebieden van de Lood/van het Contact/van de Kans moet rapporteren)
* [Verklarende woordenlijst van  [!DNL Marketo Measure]  gebieden](/help/glossary.md)

**Problemen oplossen**

* [Het verlenen van  [!DNL Marketo Measure]  Toegang van de Steun aan SFDC](/help/salesforce-access.md)
...
* Toewijzing [!DNL Salesforce] campagnes aan kanalen
