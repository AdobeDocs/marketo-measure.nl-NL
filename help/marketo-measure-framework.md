...
De Marketo Measure JavaScript volgt alle online marketinginteracties, ook wel aanraakpunten genoemd, die de vooruitzichten en leads voor uw organisatie hebben. Het is een aangepast script dat wordt toegevoegd vóór de afsluitende tag `</head>` op elke pagina van uw website.
...
![&#x200B; Marketo Measure integreert met CRMs om alle gegevens te huisvesten en te organiseren &#x200B;](assets/overview-resources-14.png)
...
![&#x200B; De meeste tellers baseren zich op een paar verschillende toepassingen om hun marketing in werking te stellen &#x200B;](assets/overview-resources-15.png)
...
**de Configuratie van de Rekening**
