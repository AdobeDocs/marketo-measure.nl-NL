...
![.&42; vertelt ons dat wij het volledige koord halen &#x200B;](assets/touchpoint-fields-10.png)
...
![&#x200B; {6} is het aantal karakters wij halen &#x200B;](assets/touchpoint-fields-12.png)
...
* Definieer de regel door te beginnen met zoeken naar het veld Touchpoint.Session.LandingPage
* Gebruik de operator &quot;extracts&quot; omdat we de waarde uit de parameter moeten halen
* Als u de waarde &quot;US&quot; wilt extraheren, definiëren we de waarde als &quot;country=(\w{2})&quot;

   * **(** merkt het begin van de extractie
   * **)** merkt het eind van de extractie
   * **\w** vertelt ons dat wij een &quot;woord&quot; halen
   * **&#x200B;**&#x200B;** is het aantal karakters wij extraheren

* Een berekend veld maken en dit veld het label &quot;Aangepaste campagne-id&quot; geven
* Definieer de regel door te beginnen met zoeken naar het veld Touchpoint.Session.LandingPage
* Gebruik de operator &quot;extracts&quot; omdat we de waarde uit de parameter moeten halen
* Om de waarde &quot;123456&quot;te halen, zullen wij de waarde als &quot;campagne_ID= (\ d {6})&quot;bepalen
...
![&#x200B; {6} is het aantal karakters wij halen &#x200B;](assets/touchpoint-fields-13.png)
...
* Om de waarde &quot;04&quot;te halen, zullen wij de waarde als &quot;BZ= (\ d ) - \ d {2} - \ d {2} - \ d {2} - \ d {2} &quot; {2} &quot; bepalen
...
* Herhaal de extractie en de toewijzing voor de resterende vier cijfersets
   ...
   * Om 01 te halen, zou u de waarde als &quot;BZ= \ d  - **(\ d**) **&#x200B; - \ d &#x200B;** - \ d **&#x200B; - \ d &#x200B;** &quot; ** &quot;
   * Om 09 te halen, zou u de waarde als &quot;BZ= \ d **- \ d** - **&#x200B; (\ d &#x200B;**) **&#x200B; - \ d &#x200B;** - \ d ** &quot;
   * Om 03 te halen, zou u de waarde als &quot;BZ= \ d **- \ d** - \ d **&#x200B; - &#x200B;** (\ d **) &#x200B;** - \ d ** &quot; bepalen
   * Om 10 te halen, zou u de waarde als &quot;BZ= \ d **- \ d** - \ d **&#x200B; - \ d &#x200B;** - **&#x200B; (\ d &#x200B;**) ** &quot; bepalen

![&#x200B; om 10 te halen, zou u de waarde als &quot;BZ= \ d &#x200B;](assets/touchpoint-fields-3.png) - \ d &rbrack;(assets/touchpoint-fields-3.png) - \ d &rbrack;(assets/touchpoint-fields-3.png) - \ d &rbrack;(assets/touchpoint-fields-3.png) - ( \ d &rbrack;(assets/touchpoint-fields-3.png)) &quot;&rbrack;(assets/touchpoint-fields-3.png) bepalen
