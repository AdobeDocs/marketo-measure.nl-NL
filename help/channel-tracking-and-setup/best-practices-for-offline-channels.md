...
>[!MORELIKETHIS]
> [ Offline Opstelling van het Kanaal ](/help/channel-tracking-and-setup/offline-custom-channel-setup.md)
> [Aangepaste campagnesynchronisatie - App Sync ](/help/channel-tracking-and-setup/custom-campaign-sync.md)
> [Offlinecampagnes synchroniseren - de Synchronisatie van CRM ](/help/channel-tracking-and-setup/syncing-offline-campaigns.md)
> [Offline Campagne &amp; Campagne Leden - de Synchronisatie van CRM ](/help/channel-tracking-and-setup/campaigns-and-campaign-members.md)
> [Datums van de Synchronisatie van de campagne - de Synchronisatie van CRM ](/help/channel-tracking-and-setup/campaign-sync-dates.md)
> [Configuraties voor de Veelvoudige Types van Verslag van de Campagne ](/help/channel-tracking-and-setup/configurations-record-types.md)
> [Het creëren van een Mening van de Lijst van de Campagne ](/help/channel-tracking-and-setup/creating-a-campaign-list-view-for-salesforce-campaigns.md)
> [Historische gegevens synchroniseren ](/help/channel-tracking-and-setup/syncing-historical-data.md)
