...
Het [!DNL Marketo Measure] -verwerkingssysteem registreert niet dat een aanraakpunt handmatig uit SFDC is verwijderd. Vanaf vandaag is er geen trigger die ons systeem signalen geeft om gegevens aan te passen. [!DNL Marketo Measure] drukt niet automatisch op een ander aanraakpunt om het verwijderde punt te vervangen. De positie of het kenmerk van het aanraakpunt wordt ook niet opnieuw toegewezen aan het volgende aanraakpunt.
...
![ wanneer een touchpoint wordt geschrapt, leidt het tot een gat in de attributie ](assets/touchpoint-settings-10.png)
