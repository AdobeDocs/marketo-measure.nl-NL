...
Als u wilt voorkomen dat uw drift-chats geschikt zijn voor het aanraakpunt, kunt u het volgende toevoegen aan `<span>` direct na het [!DNL Marketo Measure] -script voor diegenen die [!DNL Google Tag Manager] gebruiken om het [!DNL Marketo Measure] -script te laden:
