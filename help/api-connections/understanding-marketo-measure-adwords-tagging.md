---
description: Begrijpend  [!DNL Marketo Measure]  AdWords Tagging -  [!DNL Marketo Measure]
...
1. Klik op **[!UICONTROL All campaigns]** en vervolgens op **[!UICONTROL Settings]** in het uitbreidende venster.
   ...
   ![ navigatie AdWords van Google die Alle campagnemenu met de optie van Montages toont ](assets/1.png)
...
1. Klik op **[!UICONTROL Account Settings]** boven en vervolgens op **[!UICONTROL Tracking Template]** . Voer de [!DNL Marketo Measure] volgsjabloon in.
   ...
   ![ pagina van de Montages van de Rekening met het Volgen gebied van het Malplaatje voor het ingaan van de parameters van Marketo Measure ](assets/2-1.png)
...
1. Klik op **[!UICONTROL All campaigns]** en vervolgens op **[!UICONTROL Campaigns]** in het uitbreidende venster.
   ...
   ![ navigatie AdWords van Google die Alle campagnemenu met de optie van Campagnes toont ](assets/3.png)
...
1. Selecteer alle toepasselijke campagnes of **[!UICONTROL Select All]**, klik **[!UICONTROL Edit]**, en klik dan **[!UICONTROL Change Tracking Templates]**.
   ...
   ![ de selectiepagina van de Campagne met Edit menu die de Optie van Malplaatjes van de Verandering het Volgen tonen ](assets/4-1.png)
...
1. Klik op **[!UICONTROL All campaigns]** en vervolgens op **[!UICONTROL Ad Groups]** in het uitbreidende venster.
   ...
   ![ navigatie AdWords van Google die Alle campagnemenu met de optie van Groepen van de Advertentie toont ](assets/5-1.png)
...
1. Voer de [!DNL Marketo Measure] Sjabloon bijhouden in en klik op **[!UICONTROL Apply]** .
   ...
   ![ de selectiepagina van de Groep van de Groep met Edit menu dat de Optie van de Malplaatjes van de Verandering toont en knoop toepast ](assets/6-1.png)
