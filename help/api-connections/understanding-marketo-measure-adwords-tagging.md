...
* Als een doorverwijzing van een derde wordt gevonden in een volgsjabloon zoals Kenshoo of Marin, voert [!DNL Marketo Measure] geen actie uit. In plaats daarvan, moet u  [!DNL Marketo Measure]  parameters aan het derdehulpmiddel in uw rekening ](/help/api-connections/how-bid-management-tools-affect-marketo-measure.md){target="_blank"} toevoegen.[
