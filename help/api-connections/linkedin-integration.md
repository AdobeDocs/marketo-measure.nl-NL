...
Ongeacht de Campagne- of Creative-status, zullen alle reacties op formulieren resulteren in een aanraakpunt. [!DNL Marketo Measure] heeft een terugzoekbeperking van 90 dagen, zodat [!DNL Marketo Measure] geen toegang heeft tot reacties op formulieren die ouder zijn dan 90 dagen, maar als de integratie van [!DNL Marketo Measure] en [!DNL LinkedIn] langer is ingeschakeld, zijn meer aanraakpunten van het type Lead Gen Form zichtbaar via [!DNL Marketo Measure] .
...
Er zijn vier verschillende statussen voor een [!DNL LinkedIn] -campagne en Creative: Actief, Gepauzeerd, Gearchiveerd en Geannuleerd. We labelen alleen campagnes en Creative Cloud die actief zijn. Als u andere statussen codeert, stelt u deze opnieuw in op Actief. [!DNL Marketo Measure] De tag Gepauzeerde, Gearchiveerde of Geannuleerde campagnes of Creative Cloud wordt niet toegepast, maar de tag wordt hervat als de status verandert in Actief.
...
Geen zorgen. [!DNL Marketo Measure] zal programmatisch controleren op aandelen die niet meer uniek zijn, wat betekent dat deze inmiddels naar een andere Creative zijn gekopieerd. Zodra die kopie is gevonden, volgt [!DNL Marketo Measure] de gebruikelijke stroom om tags toe te wijzen en nieuwe advertenties te maken.
...
LinkedIn vereist dat alle advertenties die worden gecreeerd of gewijzigd door het normale veiligheidsproces gaan alvorens het wordt gepost. [!DNL Marketo Measure] pogingen om de advertentie zo snel mogelijk te onderscheppen, aangezien het voor nieuwe advertenties om de 6 uur maar met [!DNL LinkedIn's] extra stap scant, kan het de lancering met een paar uren vertragen.
