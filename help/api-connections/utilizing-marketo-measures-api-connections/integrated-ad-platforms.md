...
* *Optie A*: Sjabloon voor bijhouden wordt gevonden. [!DNL Marketo Measure] voegt de parameters ervan toe aan de sjabloon.
* *Optie B*: Doorverwijzing van derden is gevonden. Als er een doorleiding van derden wordt gevonden in de sjabloon Volgorde, [!DNL Marketo Measure] kan geen actie ondernemen. U moet de opdracht [!DNL Marketo Measure] -tags aan het systeem van derden. Een voorbeeld van omleiding door derden zou een instrument voor het beheren van biedingen zijn, zoals Kenshoo of Marin. Meer informatie over hoe [Bodembeheer heeft invloed op [!DNL Marketo Measure]](/help/api-connections/utilizing-marketo-measures-api-connections/how-bid-management-tools-affect-marketo-measure.md){target="_blank"}.

* *Optie C*: Er is geen sjabloon voor bijhouden gevonden. [!DNL Marketo Measure] doorzoekt al uw URL&#39;s voor advertentiebestemming naar de [!DNL Marketo Measure] parameters. Gebaseerd op de scan, indien:
...
1. Schakel in de rechterbovenhoek het gereedschap **[!UICONTROL Autotagging]** schakelen naar **[!UICONTROL Yes]**. Klik onder aan de pagina op **[!UICONTROL Learn More]** om het tekstvak uit te vouwen en klik op **[!UICONTROL Save]**. Setup voor automatisch labelen is voltooid.
...
Elk van deze hulpmiddelen heeft gedetailleerde instructies op hoe te om het te gebruiken en te wijzigen om aan uw behoeften te passen. Het gereedschap is beschikbaar [hier](https://docs.google.com/spreadsheets/d/1QCIr1WUJQHE68cA4VTks2XE7nxuryaUymCEy_23-Oew/edit#gid=0){target="_blank"}.
...
Automatisch labelen moet zijn ingeschakeld via [!DNL Marketo Measure] zodat de [!DNL Marketo Measure] parameters kunnen automatisch worden toegevoegd. Er bestaat geen risico dat de geschiedenis van eerdere advertenties met Bing Ads verloren gaat.
...
## Facebook Adds {#facebook-ads}

De [!DNL Marketo Measure] integratie met [!DNL Facebook] Hiermee kan de URL automatisch worden gedownload en informatie worden gecodeerd met de bijbehorende parameters. [!DNL Marketo Measure] gebruikt automatisch labelen om informatie over campagnes en advertentiesets weer te geven. In het veld Naam advertentieset wordt het veld Naam advertentiegroep ingevuld. Voor meer informatie over het instellen van URL-tags op het tabblad [!DNL Facebook] platform, bezoek de [!DNL Facebook] [zakendoen](https://www.facebook.com/business/help/1016122818401732/?ref=u2u){target="_blank"} pagina.
