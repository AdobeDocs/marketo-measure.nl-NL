---
description: Creërend de begeleiding van het a [!DNL Marketo Measure]  Profiel voor de gebruikers van Marketo Measure
title: Creërend a [!DNL Marketo Measure]  Profiel
...
# Een [!DNL Marketo Measure] profiel maken {#creating-a-marketo-measure-profile}

Leer hoe u een [!DNL Marketo Measure] -profiel maakt. Als u een [!DNL Marketo Measure] -profiel maakt, worden er geen validatiefouten gegenereerd wanneer u gegevens naar uw CRM verplaatst.

1. Maak een specifiek [!DNL Marketo Measure] -profiel:

   * Wijs de [!DNL Marketo Measure] beheerdersrechten toe
...
1. Een speciale [!DNL Marketo Measure] -gebruiker gemaakt:

   * Wijs het nieuwe [!DNL Marketo Measure] profiel toe aan die gebruiker
