...
* Voor meer informatie over de [!DNL Marketo Measure] verhouding met [!DNL Salesforce], bekijk [&#x200B; dit artikel &#x200B;](/help/configuration-and-setup/how-marketo-measure-and-salesforce-interact.md)
...
* U wordt gevraagd uw verwijdering te bevestigen. Zorg ervoor dat u de vraag zorgvuldig leest en begrijp de gevolgen van het verwijderen
  ...
  ![&#x200B; u wordt ertoe aangezet om uw schrapping te bevestigen. Zorg ervoor dat u de muis erboven houdt &#x200B;](assets/salesforce-migration-1.png)
...
[Pagina-indelingen](/help/configuration-and-setup/page-layout-instructions.md)

[Machtigingssets](/help/configuration-and-setup/marketo-measure-permission-sets.md)
...
[Overbodige rapporttypen verbergen](/help/configuration-and-setup/hiding-unnecessary-report-types.md)

[Aangepaste workflow indien van toepassing](/help/channel-tracking-and-setup/using-a-custom-revenue-amount-field.md)
