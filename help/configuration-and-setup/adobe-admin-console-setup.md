---
description: Hulplijnen voor het instellen van Marketo Measure-toegang via Adobe Admin Console-profielen en aanmelden
...
Als product in de Adobe Suite gebruikt [!DNL Marketo Measure] de volledige functionaliteit van Adobe Admin Console voor Identity Management. Meer middelen kunnen worden gevonden [&#x200B; hier &#x200B;](https://helpx.adobe.com/enterprise/using/admin-console.html).
...
![&#x200B; op de toegang tot van Adobe Admin Console, ziet u uw Marketo Measure &#x200B;](assets/adobe-setup-1.png)
...
![&#x200B; klikkend de Kaart van het Product van Marketo Measure toont u al uw &#x200B;](assets/adobe-setup-2.png)
...
![&#x200B; nadat een gebruiker aan een Profiel van het Product is toegevoegd, zijn zij geschikt &#x200B;](assets/adobe-setup-3.png)
