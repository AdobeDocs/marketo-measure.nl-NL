...
![&#x200B; om het volledige berichtbericht in Marketo Measure te zien, klik Mening &#x200B;](assets/adobe-setup-1.png)
...
De documentatie van Salesforce op debiettrekkers <a href="https://admin.salesforce.com/blog/2023/what-is-a-record-triggered-flow#:~:text=A%20record%2Dtriggered%20flow%20allows,is%20created%20and%2For%20updated"> kan hier </a> worden gevonden.
    ...
    <tr>
      ...
      <td>Controleer de triggercode waardoor het invoegen/bijwerken mislukt. Raadpleeg de volgende Salesforce-documentatie voor meer informatie over triggers:
        ...
        <p>
        Verstrek alle noodzakelijke toestemmingen aan de <a href="/help/configuration-and-setup/how-marketo-measure-and-salesforce-interact.md"> gebruiker van Marketo Measure </a>.
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>Verwijs naar het volgende <a href="/help/configuration-and-setup/how-marketo-measure-and-salesforce-interact.md"> artikel van Experience League </a> voor begeleiding op de toestemmingen Marketo Measure vereist.</td>
    </tr>
    <tr>
      ...
      <td>Raadpleeg de volgende Help-artikelen voor een correcte configuratie:
        <ul>
          <li>
            <a href="/help/adobe-analytics.md"> Integraties van Marketo Measure met Adobe Analytics </a>
          </li>
          <li>
    ...
    <tr>
      ...
      <td>We hebben lees- en schrijfmachtigingen nodig voor alle velden die vooraf zijn ingesteld op "bizible2__". Een volledige lijst van deze gebieden kan <a href="/help/configuration-and-setup/how-marketo-measure-and-salesforce-interact.md"> in dit artikel </a> worden gevonden.</td>
    </tr>
    <tr>
      ...
      <td>Raadpleeg het volgende Experience League-document voor hulp bij het inschakelen van deze machtiging in uw CRM <br/>
          <a href="/help/marketo-measure-salesforce-reporting/enabling-the-permission-to-edit-converted-leads.md"> toelatend de Toestemming om Omgezette Leads uit te geven </a></td>
    </tr>
    <tr>
    ...
    SystemModstamp,isDelette,WhoId,bizible2__Bizible_Touchpoint_Date__c</td>
      ...
      <td>Raadpleeg de volgende Help-artikelen voor richtlijnen over de machtigingen die Marketo Measure vereist:
        <ul>
          <li><a href="/help/marketo-measure-dynamics-schema.md"> Dynamica </a>
          </li>
    ...
    <tr>
      ...
      <td>Er zijn verschillende redenen voor deze fout die specifiek zijn voor de Salesforce org. Hieronder volgen enkele veelvoorkomende stappen voor het oplossen van problemen die het probleem kunnen oplossen:
        <ul>
          <li>Herzie alle toestemmingen wij voor elk <a href="/help/configuration-and-setup/how-marketo-measure-and-salesforce-interact.md"> voorwerp en gebied </a> vereisen.</li>
    ...
    <tr>
      ...
      <td>Voer een upgrade uit op uw pakket naar de meest recente versie:
        <ul>
          <li><a href="/help/configuration-and-setup/best-practices-for-marketo-measure-crm-package.md"> Beste praktijken </a>
          </li>
          <li><a href="/help/microsoft-dynamics-crm-installation-guide.md"> Dynamica </a>
          </li>
