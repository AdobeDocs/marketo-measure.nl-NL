...
1. Klik op de knop **[!UICONTROL Connect]** naast [!UICONTROL Microsoft Dynamics CRM] .

1. Selecteer [!UICONTROL Credentials] of [!UICONTROL OAuth] .

   >[!NOTE]
   >
   >Voor meer informatie over OAuth, bezoek [ dit artikel ](/help/oauth-with-azure-active-directory-for-dynamics-crm.md). Neem contact op met uw [!DNL Marketo Measure] accountvertegenwoordiger als u vragen hebt over het proces.
