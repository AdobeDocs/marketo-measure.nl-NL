...
Het snelheidsdashboard biedt een dynamisch beeld van het tempo waarin de vooruitzichten door de verkoop funnel bewegen, die Marktdeelnemers en verkoopteams essentiële inzichten in omzettingstijden over diverse kanalen verstrekt. Dit hulpmiddel is van onschatbare waarde voor het beantwoorden van zeer belangrijke vragen over de duur van de loodconversie en de efficiency van vooruitgang door verkoopstadia, toelatend u om uw betrokkenheidsstrategieën voor versnelde groei en omzettingen te optimaliseren.
...
![&#x200B; hoe vergelijk de tijd die in het &quot;Eerste aanraak&quot;stadium wordt doorgebracht met &#x200B;](assets/lead-dashboard-1.png)
...
![&#x200B; waarin de maand leidde/contacten de snelste vooruitgang door de verkoop &#x200B;](assets/lead-dashboard-2.png) ervaart

### Snelheid lood/contact via kanaal {#lead-contact-velocity-by-channel}

In het staafdiagram wordt de gemiddelde duur in dagen weergegeven die de contacten/leads in elk funnel-werkgebied blijven, gesegmenteerd door Kanaal.
...
![&#x200B; hoe varieert de loodsnelheid in het &quot;MQL&quot;stadium over verschillende &#x200B;](assets/lead-dashboard-3.png)
